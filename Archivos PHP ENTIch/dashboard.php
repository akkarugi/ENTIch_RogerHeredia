...
<form method="POST" action="profile_update.php">
    ...
    <p><label for="profile_email">Email:</label><input type="email" value="{$creator["email"]}" name="email" id="profile_email" /></p>
    <p><label for="profile_description">Descripcion:</label>
    <textarea name="description" id="profile_description">{$creator["description"]}</textarea></p>
